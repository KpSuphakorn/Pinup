  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        // Handle Med-density Residential Area data
        if (meddenseresareaResponse.status === 'fulfilled') {
          const data = meddenseresareaResponse.value;
          setMedDenseResAreaData(data);
        } else {
        ...
        if (educationResponse.status === 'fulfilled') {
          const data = educationResponse.value;
          setEducationData(data);
        }
        else {
          console.error('Failed to fetch Education data:', educationResponse.reason);
        }

        // Handle Government data
        if (governmentResponse.status === 'fulfilled') {
          const data = governmentResponse.value;
