  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        // Handle High-density Residential Area data
        if (highdenseresareaResponse.status === 'fulfilled') {
          const data = highdenseresareaResponse.value;
          setHighDenseResAreaData(data);
        } else {
